package org.lcwd.hotel.exception;

import org.lcwd.hotel.payload.ApiResonse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResonse> handleHotelNotFoundException(ResourceNotFoundException ex) {
